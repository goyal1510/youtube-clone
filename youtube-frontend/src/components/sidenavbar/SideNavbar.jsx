...
const SideNavbar = ({ sideNavBar }) => {
  return sideNavBar ? (
    <div className="home-sideNavbar">
      ...
      <div className="home-sideNavbarBottom">
        ...
        <div className="home_sideNavbarTopOption">
          <img
            className="home_sideNavbar_ImgLogo"
            src="https://media.licdn.com/dms/image/v2/D4E0BAQGilyx4yymW7w/company-logo_200_200/company-logo_200_200/0/1663341765171/thelallantop_logo?e=2147483647&v=beta&t=9Rw5mbCCUxZ_jso6MkNReckIFnflx6HAsVSLEzYIdIM"
            alt="The LallanTop"
          />
    ...
    <div className="home_sideNavbarMinimized">
      <div className="home_sideNavbarTopOption">
        <HomeIcon />
      </div>
      <div className="home_sideNavbarTopOption">
